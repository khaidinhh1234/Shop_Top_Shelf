...
const Home = () => {
  return (
    <div>
      ...
      <div>
        <div
          className={`w-full flex justify-center bg-[url(${banner})] bg-cover`}
        >
          <div className="lg:w-[1440px] h-[1440px] mb:w-[342px] md:w-[95vw] md:h-[720px] mb:h-[694px] justify-between">
            {/* about */}
                ...
                <div className="flex flex-col lg:gap-y-8 mb:gap-y-1.5 justify-between lg:p-[32px] mb:px-3.5 mb:pb-3.5 rounded-xl border">
                  ...
                  <div className="flex flex-col gap-y-6">
                    ...
                    <p className="text-[#717378] lg:-mt-1.5 -mt-[6.5px] lg:text-[14px] mb:text-[12px]">
                      ...
                      transaction.import {banner} from
                      '@/assets/images/Component 1.jpg';
                    </p>
                  </div>
                </div>
              </div>
