              ...
              <div className="flex flex-col lg:gap-y-5">
                  ...
                  <div className="flex lg:items-center mb:items-end justify-between">
                    <span className="font-medium text-[#EB2606] lg:text-xl lg:tracking-[0.7px] mb:text-base flex items-center lg:gap-x-3 lg:mt-0.5 mb:gap-x-2">
                      <del className="font-light lg:text-sm mb:text-sm text-[#9D9EA2]">
                        ${product.regular_price.toLocaleString("eu-US")}
                      </del>
                      $
                      {(
                ...
                <div className="flex flex-col lg:gap-y-3 mb:gap-y-2 lg:mt-[2px] mt-[3px] lg:pb-0 mb:pb-[21px]">
                  ...
                  <p className="text-[14px] text-[#46494F]">
                    ...
                    infamous Slurricane X Gorilla Glue #4 strains.
                  </p>
                </div>
                {/* row 4 */}
                  ...
                  <div className="flex flex-col gap-y-3.5 lg:pb-0 mb:pb-6 tracking-[-0.2px]">
                    <section className="flex justify-between *:font-medium *:text-sm">
                      <div className="flex gap-4">
                        {" "}
                        <span className="flex gap-x-4 text-[#46494F] w-40 truncate">
                          {product.name}
                        </span>
                        <p className="text-[#9D9EA2]">{product.quantity}x</p>
                      </div>
                      <strong>
                        {" "}
                        $
                    ...
                    <div className="border rounded-2xl lg:p-6 mb:p-5">
                      ...
                      <section className="flex flex-col gap-y-4">
                        ...
                        <p className="text-[#1A1E26] text-base">
                          ...
                          recommend them to all my friends and family for their
                          420 needs.
                        </p>
                      </section>
                    </div>
                  ...
                  <div className="flex gap-x-4 border-b pb-5">
                    ...
                    <div className="w-full flex flex-col gap-y-5">
                      <section className="w-full flex flex-col gap-y-1.5">
                        ...
                        <div className="w-full flex justify-between items-center">
                          <span className="flex gap-x-2 text-[#717378] font-light">
                            2x<p className="font-normal">$120.00</p>
                          </span>
                          <p>$245.00</p>
                        </div>
                      </section>
                      <section className="w-full flex flex-col gap-y-1.5">
                        ...
                        <div className="w-full flex justify-between items-center">
                          <span className="flex gap-x-2 text-[#717378] font-light">
                            1x<p className="font-normal">$2.00</p>
                          </span>
                          <p>$2.00</p>
                        </div>
                      </section>
                      <section className="w-full flex flex-col gap-y-1.5">
                        ...
                        <div className="w-full flex justify-between items-center">
                          <span className="flex gap-x-2 text-[#717378] font-light">
                            1x<p className="font-normal">$3.00</p>
                          </span>
                          <p>$3.00</p>
                        </div>
                      </section>
                      <span className="pt-5 flex justify-between text-[#9D9EA2] text-sm border-t">
                        Subtotal <p className="text-[#060709]">$245.00</p>
                      </span>
                    </div>
                  </div>
                  {/* item */}
                  <div className="flex gap-x-4 border-b pb-5">
                    ...
                    <div className="w-full flex flex-col gap-y-5">
                      <section className="w-full flex flex-col gap-y-1.5">
                        ...
                        <div className="w-full flex justify-between items-center">
                          <span className="flex gap-x-2 text-[#717378] font-light">
                            5x<p className="font-normal">$13.00</p>
                          </span>
                          <p>$65.00</p>
                        </div>
                      </section>
